...
public class recipe08_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recipe08);
        ...
        boolean checked = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("eggs4CheckBox", false);
        ...
        boolean checked2 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("milk5CheckBox", false);
        ...
        boolean checked3 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("bagelsCheckBox", false);
        ...
        boolean checked4 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("butter5CheckBox", false);
        ...
        boolean checked5 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("cheeseSliceCheckBox", false);
        ...
        boolean checked6 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("baconSliceCheckBox", false);
        ...
        switch(view.getId()) {
            case R.id.ingred_cb01:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("eggs4CheckBox", ((CheckBox) findViewById(R.id.ingred_cb01)).isChecked()).commit();
                break;

            case R.id.ingred_cb02:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("milk5CheckBox", ((CheckBox) findViewById(R.id.ingred_cb02)).isChecked()).commit();
                break;

            case R.id.ingred_cb03:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("bagelsCheckBox", ((CheckBox) findViewById(R.id.ingred_cb03)).isChecked()).commit();
                break;

            case R.id.ingred_cb04:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("butter5CheckBox", ((CheckBox) findViewById(R.id.ingred_cb04)).isChecked()).commit();
                break;

            case R.id.ingred_cb05:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("cheeseSliceCheckBox", ((CheckBox) findViewById(R.id.ingred_cb05)).isChecked()).commit();
                break;

            case R.id.ingred_cb06:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("baconSliceCheckBox", ((CheckBox) findViewById(R.id.ingred_cb06)).isChecked()).commit();
                break;

            case R.id.receipe01_rec_cb01:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("recipe8CheckBox", ((CheckBox) findViewById(R.id.receipe01_rec_cb01)).isChecked()).commit();
                break;
        }
    }
}