...
public class recipe04_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recipe04);
        ...
        boolean checked = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("oliveOil7CheckBox", false);
        ...
        boolean checked2 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("garlicClover7CheckBox", false);
        ...
        boolean checked3 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("courgettes7CheckBox", false);
        ...
        boolean checked4 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("frozenPeas7CheckBox", false);
        ...
        boolean checked5 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("canCannelliniBeanCheckBox", false);
        ...
        boolean checked6 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("vegetableStockCheckBox", false);
        ...
        boolean checked7 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("pestoCheckBox", false);
        ...
        switch(view.getId()) {
            case R.id.ingred_cb01:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("oliveOil7CheckBox", ((CheckBox) findViewById(R.id.ingred_cb01)).isChecked()).commit();
                break;

            case R.id.ingred_cb02:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("garlicClover7CheckBox", ((CheckBox) findViewById(R.id.ingred_cb02)).isChecked()).commit();
                break;

            case R.id.ingred_cb03:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("courgettes7CheckBox", ((CheckBox) findViewById(R.id.ingred_cb03)).isChecked()).commit();
                break;

            case R.id.ingred_cb04:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("frozenPeas7CheckBox", ((CheckBox) findViewById(R.id.ingred_cb04)).isChecked()).commit();
                break;

            case R.id.ingred_cb05:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("canCannelliniBeanCheckBox", ((CheckBox) findViewById(R.id.ingred_cb05)).isChecked()).commit();
                break;

            case R.id.ingred_cb06:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("vegetableStockCheckBox", ((CheckBox) findViewById(R.id.ingred_cb06)).isChecked()).commit();
                break;

            case R.id.ingred_cb07:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("pestoCheckBox", ((CheckBox) findViewById(R.id.ingred_cb07)).isChecked()).commit();
                break;

            case R.id.receipe01_rec_cb01:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("recipe4CheckBox", ((CheckBox) findViewById(R.id.receipe01_rec_cb01)).isChecked()).commit();
                break;
        }
    }
}