...
public class recipe06_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recipe06);
        ...
        boolean checked = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("potatoe2CheckBox", false);
        ...
        boolean checked2 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("onion2CheckBox", false);
        ...
        boolean checked3 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("milk2CheckBox", false);
        ...
        boolean checked4 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("butter2CheckBox", false);
        ...
        boolean checked5 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("salt3CheckBox", false);
        ...
        boolean checked6 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("flour2CheckBox", false);
        ...
        boolean checked7 = PreferenceManager.getDefaultSharedPreferences(this)
                .getBoolean("cheddarCheeseCheckBox", false);
        ...
        switch(view.getId()) {
            case R.id.ingred_cb01:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("potatoe2CheckBox", ((CheckBox) findViewById(R.id.ingred_cb01)).isChecked()).commit();
                break;

            case R.id.ingred_cb02:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("onion2CheckBox", ((CheckBox) findViewById(R.id.ingred_cb02)).isChecked()).commit();
                break;

            case R.id.ingred_cb03:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("milk2CheckBox", ((CheckBox) findViewById(R.id.ingred_cb03)).isChecked()).commit();
                break;

            case R.id.ingred_cb04:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("butter2CheckBox", ((CheckBox) findViewById(R.id.ingred_cb04)).isChecked()).commit();
                break;

            case R.id.ingred_cb05:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("salt3CheckBox", ((CheckBox) findViewById(R.id.ingred_cb05)).isChecked()).commit();
                break;

            case R.id.ingred_cb06:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("flour2CheckBox", ((CheckBox) findViewById(R.id.ingred_cb06)).isChecked()).commit();
                break;

            case R.id.ingred_cb07:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("cheddarCheeseCheckBox", ((CheckBox) findViewById(R.id.ingred_cb07)).isChecked()).commit();
                break;

            case R.id.receipe01_rec_cb01:
                PreferenceManager.getDefaultSharedPreferences(this).edit()
                        .putBoolean("recipe6CheckBox", ((CheckBox) findViewById(R.id.receipe01_rec_cb01)).isChecked()).commit();
                break;
        }
    }
}
